...
@ContextConfiguration(classes = {AppWebConfiguration.class, JPAConfiguration.class, DataSourceConfigurationTest.class,
                                 UserServiceImpl.class, UserDAOImpl.class,IdiomServiceImpl.class,IdiomDAOImpl.class,
...
public class IdiomControllerTest {
    ...
    public void ShouldnotPermitAcessToRoleUSER() throws Exception{
        mock.perform(MockMvcRequestBuilders.get("/idiom")
    ...
    @Test
    public void shouldReturnPageWithIdioms() throws Exception{
        mock.perform(MockMvcRequestBuilders.get("/idiom")
                    .with(SecurityMockMvcRequestPostProcessors
                        .user("admin@casadocodigo.com.br").password("123456")
                        .roles("ADMIN")))
                .andExpect(MockMvcResultMatchers.model().attributeExists("idioms"))
                .andExpect(MockMvcResultMatchers.forwardedUrl("/WEB-INF/views/idiom/idiom-list.jsp"));
    }
    
    @Test
    public void shouldDelete() throws Exception{
        mock.perform(MockMvcRequestBuilders.get("/idiom/deleteidiom/755")
                    .with(SecurityMockMvcRequestPostProcessors
                        .user("admin@casadocodigo.com.br").password("123456")
                        .roles("ADMIN")))
                .andExpect(MockMvcResultMatchers.status().is(200));
